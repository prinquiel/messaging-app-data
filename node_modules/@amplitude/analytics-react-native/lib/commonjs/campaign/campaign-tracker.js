...
class CampaignTracker {
  constructor(apiKey, options) {
    ...
    this.storageKey = (0, _analyticsCore.getCookieName)(apiKey, _analyticsCore.MKTG);
    this.parser = new _analyticsCore.CampaignParser();
    ...
    this.initialEmptyValue = options.initialEmptyValue ?? _analyticsCore.EMPTY_VALUE;
  }
  ...
  createCampaignEvent(campaign) {
    ...
    return {
      ...(0, _analyticsCore.createIdentifyEvent)(identifyEvent),
