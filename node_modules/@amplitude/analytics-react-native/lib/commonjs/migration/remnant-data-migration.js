...
class RemnantDataMigration {
  ...
  async callNativeFunction(action) {
    try {
      ...
      var _this$logger;
      (_this$logger = this.logger) === null || _this$logger === void 0 || _this$logger.error(`can't call native function: ${String(e)}`);
      return undefined;
    }
  }
  callNativeAction(action) {
    try {
      ...
      var _this$logger2;
      (_this$logger2 = this.logger) === null || _this$logger2 === void 0 || _this$logger2.error(`can't call native function: ${String(e)}`);
    }
  }
